...
A translator. It converts **one sales / discovery-call transcript** into **one
...
A plain-text transcript of a sales / discovery call between a salesperson and a
...
and enums are the real ones from a production CRM — see
...
prospect said into their CRM: the name, the number, the price they hope to get, the objection
they raised, and the thing they agreed to do next. It is 5-10 minutes of dull data entry per
call, and the reason nobody automates it is that the last tool they tried invented a close
date or a budget the prospect never gave. This one refuses to.
